...
/*
  for( unsigned i = 0; i < 13; i++ ) {
    predator->current_state[i] = pred_state[i];
  }

  for( unsigned i = 0; i < 10; i++ ) {
    predator->compute_feedback( predator->current_state, predator->desired_state, predator->current_control, predator->feedback_control );
 
    printf( "pred: feedback_control[%f,%f,%f,%f,%f,%f]\n", predator->feedback_control[0], predator->feedback_control[1], predator->feedback_control[2], predator->feedback_control[3], predator->feedback_control[4], predator->feedback_control[5] );
    predator->time += predator->dtime;
  }
*/
}
